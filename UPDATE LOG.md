...
- Suspends the keep-running supervisor during a publisher installation, publishes the update feed before relaunch, and relocates the duplicate updater backups generated by the defect out of Applications without deleting them.
- Preserves Bradley's completed VeloViewer import and all three already-reviewed leaderboard cases while retaining the 24-position Top 20 index, 17-position Top 10 baseline, and 22 starred weather segments.
